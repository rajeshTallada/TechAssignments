	...
	@Test
		...
		public static void autoTest() throws InterruptedException {
	        ...
	        try {
	            ...
	            Thread.sleep(4000);	
	            WebElement processDiscoveryLink = driver.findElement(By.xpath("/html/body/div[1]/header/div/div/div/div[2]/div/div/div[2]/ul/li[2]/div/div/div/div/div[3]/ul/li[1]/ul/li/a"));
